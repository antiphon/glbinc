...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(glm_binom_std_c(X, y, offset, center, scale, add_intercept, verb, eps, maxiter, w_limit, stability_threshold));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type w_limit(w_limitSEXP);
    Rcpp::traits::input_parameter< double >::type stability_threshold(stability_thresholdSEXP);
    rcpp_result_gen = Rcpp::wrap(glm_binom_std_sparse_c(X, y, offset, center, scale, add_intercept, verb, eps, maxiter, w_limit, stability_threshold));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_hello
...
BEGIN_RCPP
    ...
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type x(xSEXP);
    rcpp_result_gen = Rcpp::wrap(sparse_c(x));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport void R_init_glbinc(DllInfo *dll) {
